              ...
              <div className="w-[900px] h-[750px] relative text-center p-5 bg-base-200 rounded-xl">
                ...
                <div className="absolute right-[37.5px] top-[500px] w-[420px] h-[40px] border-base-content border-2 text-xs">
                  <div className="tooltip tooltip-hover" data-tip="Panjang Lonjor Tulangan">
                    <div className="join join-horizontal">
                      ...
                      <input type="number" className="join-item input input-sm input-bordered w-24" defaultValue={12000} />
                ...
                <div className="absolute left-[75px] top-[45px] w-[75px] h-[45px] border-secondary border-b-2">
                  ...
                  <div className="tooltip" data-tip="VARIABLE">
                    <div className="join join-horizontal">
                      <input type="number" className="join-item input input-sm input-bordered w-20" defaultValue={0.67} step={0.01} />
                ...
                <div className="absolute left-[90px] top-[150px] w-[75px] h-[75px] border-secondary border-l-2">
                  ...
                  <div className="tooltip mt-5" data-tip="VARIABLE">
                    <div className="join join-horizontal">
                      <input type="number" className="join-item input input-sm input-bordered w-20" defaultValue={12} />
                ...
                <div className="absolute left-[300px] top-[45px] w-[75px] h-[40px] border-secondary border-b-2">
                  ...
                  <div className="tooltip" data-tip="VARIABLE">
                    <div className="join join-horizontal">
                      <input type="number" className="join-item input input-sm input-bordered w-20" defaultValue={15} />
                      <div className="join-item btn btn-sm btn-info">D</div>
                    </div>
                  </div>
                </div>
                <div className="absolute left-[225px] top-[270px] w-[75px] h-[40px] border-secondary border-b-2">
                  ...
                  <div className="tooltip" data-tip="VARIABLE">
                    <div className="join join-horizontal">
                      <input type="number" className="join-item input input-sm input-bordered w-20" defaultValue={20} />
                      <div className="join-item btn btn-sm btn-info">D</div>
                    </div>
                  </div>
                </div>
                <div className="absolute left-[150px] top-[360px] w-[150px] h-[40px] border-secondary border-b-2">
                  ...
                  <div className="tooltip mb-2" data-tip="VARIABLE">
                    <div className="join join-horizontal">
                      <input type="number" className="join-item input input-sm input-bordered w-20" defaultValue={0.25} />
                ...
                <div className="absolute left-[150px] top-[490px] w-[105px] h-[40px] border-secondary border-b-2">
                  ...
                  <div className="tooltip mb-2" data-tip="VARIABLE">
                    <div className="join join-horizontal">
                      <input type="number" className="join-item input input-sm input-bordered w-20" defaultValue={40} />
                      <div className="join-item btn btn-sm btn-info">D</div>
                    </div>
                  </div>
                </div>
                <div className="absolute left-[150px] top-[700px] w-[150px] h-[40px] border-secondary border-b-2">
                  ...
                  <div className="tooltip mb-2" data-tip="VARIABLE">
                    <div className="join join-horizontal">
                      <input type="number" className="join-item input input-sm input-bordered w-20" defaultValue={500} />
                ...
                <div className="absolute right-[90px] top-[630px] w-[130px] h-[50px] border-secondary border-l-2">
                  ...
                  <div className="tooltip mt-3" data-tip="VARIABLE">
                    <div className="join join-horizontal">
                      <input type="number" className="join-item input input-sm input-bordered w-20" defaultValue={0.3} />
